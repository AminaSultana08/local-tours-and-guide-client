...
const Navbar = () => {
    ...
    return (
        ...
        <div className="md:flex dark:bg-zinc-700 dark:text-white lg:flex items-center justify-between bg-white bg-transparent  py-8 md:px-10 px-7 lg:px-10">
            ...
            <ul className= {`absolute md:static left-0 w-full md:auto  md:z-auto z-[-1] md:flex lg:flex md:items-center pb-12 md:pb-0 md:pl-0 pl-9 transition-all duration-500 ease-in md:my-0 my-7 lg:items-center text-xl md:ml-8  ${open? 'top-20 opacity-100': 'top-[-490px] opacity-0 md:opacity-100 ' }  `}>
            {navLinks}
            <Button >Login</Button>
