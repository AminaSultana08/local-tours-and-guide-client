...
const Home = () => {
    ...
    <Banner></Banner>
            ...
            <div className="dark:bg-zinc-800  font-Playpen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 font-Playpen items-center justify-center mx-auto px-5 md:px-0 lg:px-0 md:mx-2 lg:mx-10 lg:mr-4 ">
           ...
           <div className="flex justify-center">
            ...
            <Link to='/services' ><button onClick={()=>{setDataLength(services.length)}} className="btn    bg-gradient-to-r from-red-500 to-amber-600 hover:from-pink-500 hover:to-yellow-500  font-Playpen rounded-lg font-bold  text-white btn-primary px-5  py-3 my-10 block w-full">Show All</button></Link>
            </div>
           </div>
            </div>
            </div>
